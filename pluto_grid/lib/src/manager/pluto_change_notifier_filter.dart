...
class PlutoNotifierFilterResolverDefault
  ...
  Set<int> resolve(PlutoGridStateManager stateManager, Type type) {
    switch (type) {
      ...
      case PlutoBodyColumns _:
      case PlutoBodyColumnsFooter _:
      case PlutoLeftFrozenColumns _:
      case PlutoLeftFrozenColumnsFooter _:
      case PlutoRightFrozenColumns _:
      case PlutoRightFrozenColumnsFooter _:
        return defaultColumnsFilter(stateManager);
      case PlutoBodyRows _:
      case PlutoLeftFrozenRows _:
      case PlutoRightFrozenRows _:
        return defaultRowsFilter(stateManager);
      case PlutoNoRowsWidget _:
        return {
          ...defaultRowsFilter(stateManager),
          stateManager.setShowLoading.hashCode,
        };
      case PlutoAggregateColumnFooter _:
        return defaultAggregateColumnFooterFilter(stateManager);
      case CheckboxSelectionWidget _:
        return defaultCheckboxFilter(stateManager);
      case CheckboxAllSelectionWidget _:
